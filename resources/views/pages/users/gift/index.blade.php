        ...
        <div class="row">
          ...
          <div class="col-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"> Create Gift Code</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-4 mb-4">
            <div class="card balance-box h-100">
                <div class="card-body d-flex align-items-center justify-content-center">
                    <form id="giftCodeForm" method="POST" action="{{ route('gift.store') }}">
                        @csrf
                        <div class="balance-profile">
                            <h5 class="f-light d-block mb-4">Jumlah Balance </h5>
                            <div class="mb-4 m-form__group">
                                <div class="input-group"><span class="input-group-text">Rp</span>
                                    <input class="form-control" type="number" id="nominal" name="nominal" placeholder="1">
                                </div>
                            </div>
                            <div class="pricingtable-signup">
                                <button class="btn btn-primary btn-lg" type="button" id="depositBtn">Create Gift Code</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card h-100">
                <div class="card-body method">
                    <div id="message" class="row">
                        <div id="message" class="row">
                            <div class="col-sm-12">
                                <h5 class="f-light mb-3">Panduan Membuat Gift Code</h5>
                            </div>
                            <div class="col-sm-12">
                                <div class="list-method">
                                    <p class="mb-2">Silahkan melakukan deposit terlebih dahulu untuk menggunakan layanan Gift Code</p>
                                    <ol class="mb-2"> 
                                        <li>Silahkan isi jumlah yang ingin anda depositkan (Ex. Rp.1).</li>
                                        <li>Masukkan nilai atau jumlah untuk Gift Code tersebut, Pastikan Saldo Anda Cukup.</li>
                                        <li>Anda juga dapat Membagikan Code Gift Kepada Teman Atau Rekan Anda, Jika Diperlukan.</li>
                                        <li>Klik 'Create Gift Code' atau 'Buat' untuk menghasilkan Gift Code.</li>
                                        <li>Setelah berhasil, catat atau salin Gift Code yang telah dibuat untuk distribusi selanjutnya.</li>
                                    </ol>
                                    <p class="text-muted" style="font-size:x-small"> 
                                        *Pastikan untuk menyimpan Gift Code di tempat yang aman. <br>
                                        **Jika Anda menghadapi masalah saat membuat Gift Code, silakan <a href="#" class="fw-bold">hubungi Customer Service kami</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('#depositBtn').click(function() {
            ...
            $.ajax({
                ...
                complete: function() {
                    $('#depositBtn').html('Create Gift Code');
