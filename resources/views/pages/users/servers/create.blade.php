                    ...
                    <div class="card h-100">
                        <div class="card-body text-start">
                            <form id="createAccounts" method="POST"
                                ...
                                <div class="col-12 mb-3">
                                    <label class="form-label" for="permission">Pilih Durasi Pembelian</label>
                                    <div class="form-check">
                                        <input class="form-check-input" id="monthly" type="radio" name="metode"
                                            value="1" checked>
                                        <label class="form-check-label" for="monthly">Monthly | <b>IDR.
                                                {{ number_format($serverData->prices->where('role_id', Auth::user()->roles->first()->id)->first()->price_monthly, 2) }}</b></label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" id="hourly" type="radio" name="metode"
                                            value="2">
                                        <label class="form-check-label" for="hourly">Hourly | <b>IDR.
                                                {{ number_format($serverData->prices->where('role_id', Auth::user()->roles->first()->id)->first()->price_hourly, 2) }}</b></label>
                                    </div>
                                    <div class="form-check">
